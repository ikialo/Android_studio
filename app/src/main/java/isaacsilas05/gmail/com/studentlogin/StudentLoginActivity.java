package isaacsilas05.gmail.com.studentlogin;
...
import isaacsilas05.gmail.com.studentlogin.R;
                                ...
                                .addOnCompleteListener(StudentLoginActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Intent intent = new Intent(StudentLoginActivity.this, StudentSpaceActivity.class);
